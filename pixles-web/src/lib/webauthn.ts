...
function prepareCreationOptions(options: Record<string, unknown>): PublicKeyCredentialCreationOptions {
    ...
    return {
        ...
        user: {
            ...
            id: base64urlToBuffer((pk.user as Record<string, unknown>).id as string),
        },
...
export async function authenticateWithPasskey(requestOptions: unknown): Promise<unknown> {
    const options = prepareRequestOptions(requestOptions as Record<string, unknown>);
...
export async function registerPasskey(creationOptions: unknown): Promise<unknown> {
    const options = prepareCreationOptions(creationOptions as Record<string, unknown>);
